...
const Header = ({ worksHash, isHome, ...rest }) => (
  <FlexBox as="header" justifyContent="space-between" flexDirection={{ M: "column" }} {...rest}>
    <Link href={isHome ? "/about" : "/"}>
      <a>
        <Tanya variant="header" fg="blue" isHome={isHome}>
          <Name>About</Name>
          <About>About</About>
        </Tanya>
      </a>
    ...
    {isHome ? (
      <HashLink hash={worksHash} variant="header" fg="red" modifyUrl={false}>
        works
      </HashLink>
    ) : (
